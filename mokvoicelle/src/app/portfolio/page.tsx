...
import { ArrowLeft, Play, ExternalLink, Image as ImageIcon, Film, X, Eye } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
            <div className="max-w-3xl">
              <span className="text-xs font-mono uppercase tracking-widest px-3 py-1 rounded-full bg-[#1E3DF0]/10 border border-[#1E3DF0]/20 text-[#1E3DF0] mb-4 inline-block">
                Complete Project Archive
              </span>
              <h1 className="text-4xl md:text-6xl font-extrabold tracking-tight mb-6">
                Engineered Case Studies & Works
              </h1>
              <p className="text-slate-400 text-lg leading-relaxed">
                Explore our full catalog of delivered projects, high-performance web applications, 3D animations, cinematic media, and brand identity design assets.
              </p>
            </div>

            {/* Filter Tabs */}
            <div className="flex flex-wrap gap-2 p-1.5 rounded-2xl bg-[#121A33] border border-slate-800 backdrop-blur-xl h-fit">
